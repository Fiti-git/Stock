...
const RealLossPage = lazy(() => import("./pages/admin/RealLossPage"));
              ...
              <BrowserRouter>
                <Suspense fallback={<FullScreenLoader />}>
                  ...
                  <Routes>
                    ...
                    <Route path="/admin/reports/real-loss" element={<PermissionRoute code="nav.manager_dashboard"><RealLossPage /></PermissionRoute>} />
